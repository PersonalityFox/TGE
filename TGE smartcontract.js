...
contract TechBenchToken is StandardToken {
    ...
    string public name = "TBCH";
    string public symbol = "TBCH";
    ...
    bool public preTge = true; //Pre-TGE state
     ...
     * Token count
     */
    uint public totalTokens = 60000000;
    uint public team = 8400000;
    uint public bounty = 600000; // Bounty count

    /**
     * TGE and Pre-TGE cap
     */
    uint public preTgeCap = 5100000; // Max amount raised during Pre-TGE is 5100 ETH (10%)
    uint public tgeCap = 51000000; // Max amount raised during TGE is 51000 ETH

    /**
     * Statistic values
     */
    uint public presaleTokenSupply = 0; // This will keep track of the token supply created during the TGE event
    uint public presaleEtherRaised = 0; // This will keep track of the Ether raised during the TGE event
    uint public preTgeTokenSupply = 0; // This will keep track of the token supply created during the Pre-TGE
